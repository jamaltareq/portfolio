        ...
        <div className=" position-relative container" >
            ...
            <div className="  row m-5">
                ...
                <div className="col-lg-7">
                    <form action="https://formsubmit.co/f17cbb931e28c6d6a346fef9854e4ed9" method="POST">
                        <label htmlFor="name">name*</label>
                        <input type="text" name="name" id="name" className='edited form-control mb-3' />
                        <label htmlFor="email">email*</label>
                        <input type="text" name="email" id="email" className='edited form-control mb-3' />
                        <label htmlFor="content">content*</label>
                        <textarea type="text" name="content" id="content" className='edited form-control  ' style={{ height: '100px', maxHeight: '150px' }} />
                        <br />
                        <button type="submit" className=" text-white btn  btn-e px-3 py-2"> <i className="fa-solid fa-envelope me-2 fs-5"></i>Send</button>
                        <a href="mailto:gamal.tarek.1907@gmail.com" className=" text-white btn  btn-e px-3 py-2 ms-3"> <i className="fa-solid fa-paper-plane me-2 fs-5"></i>Get In Touch</a>
                    </form>
                </div>
            </div>
